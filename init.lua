...
require('lazy').setup({
...

  {
    ...
    config = function()
      ...
      vim.keymap.set('n', '+', '<CMD>vsplit<CR><CMD>Oil<CR>', { desc = 'Open new vertical split' })
    end,
  },
  ...
  },
  {
    ...
    dependencies = {
      ...
      --     exe = {
      --       'dotnet',
      --       '/home/jdavis/.local/share/nvim/mason/packages/roslyn/libexec/Microsoft.CodeAnalysis.LanguageServer.dll',
      --     },
      --   },
      -- },
      ...
      local servers = {
        ...
        zls = {
          settings = {
            ...
            zig_exe_path = '/home/jdavis/.zvm/bin/zig',
            zig_lib_path = '/home/jdavis/.zvm/bin/lib',
          },
        },
        --omnisharp = {
        --  settings = {
